<template>
  <div>
		...
		<div class="card" style="margin-bottom: 5px">
			...
			<el-input v-model="data.search.category" prefix-icon="Search" style="width: 240px; margin-right: 10px; margin-bottom: 3px" placeholder="请输入任务分类"></el-input>
			<el-input v-model="data.search.status" prefix-icon="Search" style="width: 240px; margin-right: 10px; margin-bottom: 3px" placeholder="请输入任务状态"></el-input>
			<el-button type="info" plain @click="load">查询</el-button>
			<el-button type="warning" plain style="margin-right: 10px" @click="reset">重置</el-button>

			<el-upload :action="'http://localhost:9090/task/upload?token=' + data.user.token" style="display: inline-block" :show-file-list="false" :on-success="impSuccessUpload">
      ...
      <el-form :model="data.form" label-width="80px"  style="padding: 20px 30px">
				...
				<el-form-item label="任务分类" prop="category">
					<el-select style="width: 100%" v-model="data.form.category">
						...
						<el-option value="学习"></el-option>
						<el-option value="生活"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item label="任务标题" prop="title">
					<el-input v-model="data.form.title" placeholder="请输入任务标题"></el-input>
				</el-form-item>
				<el-form-item label="任务描述" prop="description">
					<el-input v-model="data.form.description" placeholder="请输入任务描述"></el-input>
				</el-form-item>
				<el-form-item label="截止日期" prop="dueDate">
					<el-date-picker v-model="data.form.dueDate" type="date" clearable value-format="YYYY-MM-DD" placeholder="选择日期" style="width: 100%"></el-date-picker>
				</el-form-item>
				...
				<el-form-item label="任务进度" prop="progress">
					<el-slider v-model="data.form.progress" :step="10" show-stops></el-slider>
				</el-form-item>
      </el-form>
      <template #footer>
...
// 导出
const exp = () => {
	location.href = 'http://localhost:9090/task/export?token=' + data.user.token
}
